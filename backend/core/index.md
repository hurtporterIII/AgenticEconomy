...
- scheduler.py.meta.json: Structured data or configuration.
- state.py: Python logic file for system behavior.
- state.py.meta.json: Structured data or configuration.
